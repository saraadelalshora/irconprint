...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><a href="{{route('training.index')}}"> التدريبات </a> </h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <a href="{{ route('training.create')}}"><button type="button"
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class=" p-t-20" method="POST" action="{{route('training.update',$training->id)}}"
                        ...
                        <div class="tab-content">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="text" id="AR" class="form-control"
                                                            ...
                                                            data-validation-required-message="هذا الحقل مطلوب" value="{{$training->name_ar}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <textarea class="summernote" name="description_ar">
                                                              ...
                                                              {!!$training->description_ar!!}      </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="" id="AR" class="form-control"
                                                            placeholder="اسم القسم" name="name_en"value="{{$training->name_en}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <textarea class="summernote" name="description_en">
                                                                 {!!$training->description_en!!}   </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="home3" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="subsubcategory" id="filter"
                                        class="form-control m-b-10 select2-multiplel" 
                                        data-validation-required-message="هذا الحقل مطلوب"> 
                                       @if(!empty($training->subtwocategory)) <option value="{{$training->subtwocategory_id}}" selected>
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1"  @if($training->status == 1)selected @endif  >تفعيل</option>
                                        <option value="0"  @if($training->status == 0)selected @endif >ايقاف</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="card">
                                                            <div class="card-body">
                                                                <label>Upload Image</label>
                                                                    <input type="file" name="pro_image" id="input-file-now" class="dropify" @if(!empty($training->image)) data-default-file="{{ asset($training->image) }}" @endif/>
                                                                </div>
                                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" data-role="tagsinput" name="tag_ar"
                                                        value="{{$training->tag_ar}}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" name="tag_en"
                                                      value="{{$training->tag_en}}"  data-role="tagsinput">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12 form-group">
                            <div class="text-left">
                                ...
                                <div class="pull-right">
                                    <a href="{{route('training.index')}}" class="btn btn-rounded btn-danger"> <span
