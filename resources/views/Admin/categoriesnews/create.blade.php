                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <form class="p-t-20" method="POST" action="{{route('CategoriesNews.store')}}"  method="post"  enctype="multipart/form-data">
                                                {{csrf_field()}}
                                        ...
                                        <div class="text-left">
                                                    ...
                                                    <div class="pull-right">
                                                        <a href="{{route('CategoriesNews.index')}}" class="btn btn-rounded btn-danger"> <span class="fa fa-sign-out"> </span> &nbsp&nbspالعوده </a>
                                                    </div>                                     
                                                </div>
                                        </div>
                                    </form>
