        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <form class="p-t-20" method="POST" action="{{route('Section.update',$page->id)}}"
                                    ...
                                    <div class="tab-pane active" id="lang_ar" role="tabpanel">
                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="text" id="AR" class="form-control"
                                                            ...
                                                            value="{{$page->name_ar}}" required name="ar_name">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" min="0" name="order"  value="{{$page->order}}"/>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">اضف صورة الخبر</label>

                                                <input type="file" id="input-file-now" name="img"
                                                    @if(!empty($page->image)) data-default-file="{{ asset($page->image) }}"
                                                @endif class="dropify" />
                                            </div>
                        ...
                        <div class="col-md-12 form-group">
                            <div class="text-left">
                                ...
                                <div class="pull-right">
                                    <a href="{{route('Section.index')}}" class="btn btn-rounded btn-danger">
