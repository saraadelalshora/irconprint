                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <form class=" p-t-20" method="POST" action="{{route('Payment.store')}}">
                                    {{csrf_field()}}
                                        <div class="tab-content">        
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                        ...
                                                        <div class="form-group">
                                                                <label for="AR" class="control-label">اسم الطريقه عربي<span class="text-danger">*</span> </label>
                                                                    <div class="input-group-prepend">
                                                                        <input type="text" id="AR" class="form-control" placeholder=" اسم الطريقه عربي" name="ar_name" required>
                                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend">
                                                                        <input type="text" id="AR" class="form-control" placeholder="اسم الطريقه انجليزي" name="en_name">
                                                                    </div>
                                                                </div>
                                                        </div>
