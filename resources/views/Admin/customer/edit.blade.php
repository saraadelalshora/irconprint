                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="p-t-20" method="POST" action="{{route('Customer.update',$customer->id)}}">
                                {{csrf_field()}}
                                {{ method_field('PATCH') }}
                                                                                ...
                                                                                <div class="row p-t-20">
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" id="firstName" name="fname" required value="{{$customer->fname}}"class="form-control" placeholder="الاسم الاول">
                                                                                    </div>
                                                                                    </div>
                                                                                    <!--/span-->
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" id="lastName" name="lname"  required value="{{$customer->lname}}"class="form-control form-control-danger" placeholder="الاسم الاخير">
                                                                                    </div>
                                                                                    </div>
                                                                                    <!--/span-->
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" id="ُEmail" class="form-control" name="email" required value="{{$customer->email}}" placeholder="البريد الالكترونى">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="tel" class="form-control" name="phone" placeholder="رقم الهاتف"  value="{{$customer->phone}}" >
                                                                                        </div>
                                                                                    </div>
                                                                                    <!--/span-->
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                        <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text" value="{{$customer->zipcode}}" name="zipcode" class="form-control">
                                                                                                </div>
                                                                                            </div>
                                                                                    <!-- <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select class="form-control m-b-10 select2-multiple"  name="country_id" id="Country" required data-validation-required-message="هذا الحقل مطلوب">
                                                                                             ...
                                                                                             <option value="{{$country->id}}" @if($customer->country_id == $country->id) selected @endif>{{$country->name_ar}}</option>
                                                                                             @endforeach
                                                                                             @endif
                                                                                         </select>
                                                                                        </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                            <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="password" id="password-confirm"  name="password_confirmation"  class="form-control"  placeholder="تاكيد كلمه المرور">
                                                                                                </div>
                                                                                    </div>
                                                                                    <!--/span-->
                                                                                </div>
                                                        ...
                                                        <div class="row p-t-20">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea  class="form-control" placeholder="اكتب تعليق" style="height:120px" name="note">{{$customer->notes}}</textarea>
                                                                </div>
                                                                </div>
                                                                <!--/span-->
