        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <form class=" p-t-20" method="POST" action="{{route('eshop.store')}}"
...
<script type="text/javascript">
    $('#Category').change(function () {
        ...
        if (countryID) {
            $.ajax({
                type: "GET",
                url: "{{url('admin/subcategory-list-shop')}}?category_id=" + countryID,
    ...
    $('#subcategory').on('change', function () {
        ...
        if (stateID) {
            $.ajax({
                type: "GET",
                url: "{{url('admin/filter-list-shop')}}?subcategory_id=" + stateID,
                success: function (res) {
                    if (res) {
                        $("#filter").empty();
