                    ...
                    <div class="col-lg-12">
                        <div class="card">
                                <div class="card-header">
                                        <h4 class="card-white m-b-0">تعديل  التصريح</h4> 
                                </div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <form class=" p-t-20" method="POST" action="{{route('permissions.update', $permission->id)}}">
                                            ...
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                        ...
                                                        <div class="form-group">
                                                                <label for="AR" class="control-label">اسم التصريح <span class="text-danger">*</span> </label>
                                                                  ...
                                                                  <input required type="text" class="form-control" name="name" required id="exampleInputEmail1" value="{{$permission->name}}" placeholder="اسم التصريح">
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend">
                                                                      <input class="form-control" required name="display_name" placeholder="اسم العرض" value="{{$permission->display_name}}" >
                                                    ...
                                                    <label class="control-label"> الوصف </label>
                                                               <textarea class="form-control"  required name="description" placeholder="الوصف"> {{$permission->description}}</textarea>
