...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">اضافه كوبون</h4>
    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-white m-b-0">اضافه كوبون جديد</h4>
            </div>
            <div class="card-body">

                <div class="form-group">
                    <form class=" p-t-20" method="POST" action="{{route('Coupon.store')}}">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        <!-- <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="control-label">رمز الكوبون</label>
                                                                <input type="text" id="firstName" name="code"  class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" name="coupon_type" Required>
                                                    ...
                                                    <option value="1">قيمة مالية</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="amount" name="value" class="form-control "
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="sdate" name="startdate" class="form-control"
                                                placeholder="تاريخ انتهاء الكوبون" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="pro-type">
                                            ...
                                            <label class="container_radio">
                                                <input type="checkbox" name="select1" value="pro1">استبعاد المنتجات
                                                <span class="checkmark"></span>

                                            </label>
                                            <label class="container_radio">
                                                <input type="checkbox" name="select2" value="pro2"> المنتجات
                                                <span class="checkmark"></span>

                                            </label>
                                            <label class="container_radio">
                                                <input type="checkbox" name="select3" value="pro3"> الاقسام
                                                <span class="checkmark"></span>

                                            </label>
                                            <label class="container_radio">
                                                <input type="checkbox" name="select4" value="pro4"> استبعاد الاقسام
                                                <span class="checkmark"></span>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="limit_per_user" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label>حد الاستخدام لكل مستخدم</label>
                                            <input type="number" name="usinglimit" class="form-control">
                                        </div>
                                    </div>
                                </div>
