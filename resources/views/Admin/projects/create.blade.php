                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <form class=" p-t-20"   action="{{route('Project.store')}}"  method="post"  enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                <label for="textarea_ar" class="control-label"> وصف المشروع <span class="text-danger">*</span></label>
                                                                 <div class="controls">
                                                                    <textarea class="summernote" id="textarea_ar" class="form-control" id="exampleTextarea" name="ar_description"  required placeholder="وصف المشروع"></textarea>
                                                                 </div>
                                                                </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane "  id="lang_en" role="tabpanel">
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea class="summernote" id="textarea_en" class="form-control" placeholder="وصف المشروع" name="en_description"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
