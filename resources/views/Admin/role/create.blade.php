                    ...
                    <div class="col-lg-12">
                        <div class="card">
                                <div class="card-header">
                                        <h4 class="card-white m-b-0">اضافة صلاحية </h4> 
                                </div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <form class=" p-t-20" method="POST" action="{{route('Roles.store')}}">
                                    {{csrf_field()}}
                                            ...
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                        ...
                                                        <div class="form-group">
                                                                <label for="AR" class="control-label">اسم التصريح <span class="text-danger">*</span> </label>
                                                                  ...
                                                                  <input  type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="اسم التصريح" required>
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend">
                                                                      <input class="form-control" required name="display_name" placeholder="اسم العرض" required >
                                                      ...
                                                      <div class="form-group">
                                                        <!-- <label class="control-label"> التصريحات </label> -->
