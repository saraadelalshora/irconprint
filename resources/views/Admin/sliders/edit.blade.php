...
@section('content')
  <!-- ============================================================== -->
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <form class="p-t-20" method="POST"action="{{route('Slider.update',$slider->id)}}"  method="post"  enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{ method_field('PATCH') }}
                        <div class="row">
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-wight m-b-0">تعديل  صورة للعرض</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="lang_ar" role="tabpanel">
                                                        <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend">
                                                                        <input type="text" id="AR" class="form-control"
                                                                            placeholder="اضف عنوان مناسب للصورة" name="ar_name" value="{{$slider->title_ar}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control"  name="short_description_ar">{{$slider->short_description_ar}}</textarea>
                                                            </div>
                                                            <hr>
                                                            <div>
                                                                <label for="textarea_ar">وصف الصورة </label>
                                                                <div class="form-group">
                                                                    <textarea class="form-control" rows="5"  name="description_ar">{{$slider->description_ar}}
                                                                    </textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="tab-pane" id="lang_en" role="tabpanel">
                                                        <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend">
                                                                        <input type="" id="AR" class="form-control"
                                                                            placeholder="اضف عنوان مناسب الصورة" name="en_name" value="{{$slider->title_en}}" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label>وصف قصير للصورة</label>
                                                                <textarea class="form-control"  name="short_description_en">{{$slider->short_description_en}}</textarea>
                                                            </div>
                                                            <hr>
                                                            <div>
                                                                <label for="textarea_ar"> وصف الصورة </label>
                                                                <div class="form-group">
                                                                    <textarea class="form-control" rows="5" name="description_en">{{$slider->description_en}}
                                                               </textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="card-body">
                                <div class="tab-pane" id="home3" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <option value="1"{{$slider->status == 1 ? 'selected="selected"' : '' }} >تفعيل</option>
                                        <option value="0" {{$slider->status == 0 ? 'selected="selected"' : '' }}>ايقاف</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="tab-pane" id="home5" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <p>1200x960</p>
                                        <br>
                                        <input type="file" id="input-file-now" name="img"  @if(!empty($slider->img)) data-default-file="{{ asset($slider->img) }}" @endif class="dropify" />
                                    </div>
                                </div>
                            </div>
                        </div>
