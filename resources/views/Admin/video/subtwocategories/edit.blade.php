        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <ul class="nav nav-tabs tabcontent-border" role="tablist">
                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home1"
                                role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span
                                    class="hidden-xs-down">القسم</span></a> </li>
                ...
                <div class="form-group">
                    <form class=" p-t-20" action="{{url('admin/video/SubtwoCategory/'.$subcategory->id)}}" method="post"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home1" role="tabpanel">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="lang_ar" role="tabpanel">
                                        <div class="form-group">
                                            <div>
                                                <label for="AR" class="control-label"> اسم القسم<span
                                                        class="text-danger">*</span> </label>
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="text" id="AR" class="form-control"
                                                            placeholder="اسم القسم" required
                                                            value="{{$subcategory->name_ar}}" name="name_ar">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div>
                                                <label for="textarea_ar">وصف القسم <span
                                                        class="text-danger">*</span></label>
                                                <div class="form-group">
                                                    <textarea rows="5" id="textarea_ar" class="form-control" required
                                                        placeholder="وصف القسم" name="description_ar">
                                    ...
                                    <div class="tab-pane" id="lang_en" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <textarea rows="5" id="textarea_ar" class="form-control"
                                                        placeholder="وصف القسم" name="description_en">
                            ...
                            <div class="tab-pane" id="home2" role="tabpanel">
                                <div class="form-group">
                                    <label class="control-label">القسم الرئيسي <span class="text-danger">*</span><span
                                            class="text-danger">(بعض الاقسام غير موجوده بسبب انها لديها فيديو لاضافة قسم
                                            فرعي لها قم بحذف الفيديو اولا)</span></label>

                                    <select class="form-control m-b-10 select2-multiple" style="width: 100%" required
                                        name="category" data-placeholder="Choose">
                                        @if(!empty($categories)) @foreach($categories as $category)
                                        @if($category->videos->isEmpty() == true )
                                        <option value="{{$category->id}}" @if($subcategory->category_id ==
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            data-default-file="{{ asset($subcategory->image) }}" @endif class="dropify"
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="home3" role="tabpanel">
                                <ul class="nav nav-tabs tabcontent-border" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab"
                                            href="#lang_ar_seo" role="tab"><span class="hidden-sm-up"><i
                                                    class="flag-icon flag-icon-eg"></i></span>&nbsp&nbspعربي <span
                                                class="hidden-xs-down"></span></a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#lang_en_seo"
                                            role="tab"><span class="hidden-sm-up"><i
                                                    class="flag-icon flag-icon-us"></i></span> <span
                                                class="hidden-xs-down">&nbsp&nbsp انجليزي </span></a> </li>
                                </ul>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" data-role="tagsinput" name="tag_ar"
                                                        value="{{$subcategory->tag_ar}}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" name="tag_en"
                                                        value="{{$subcategory->tag_en}}" data-role="tagsinput">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12 form-group">
                            <div class="text-left">
                                ...
                                <div class="pull-right">
                                    <a href="{{url('admin/video/SubtwoCategory/')}}" class="btn btn-rounded btn-danger">
