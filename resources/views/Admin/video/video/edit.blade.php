...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><a href="{{route('Video.index')}}"> الفيديو </a> </h4>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                      <form class=" p-t-20" method="POST" action="{{route('Video.update',$video->id)}}"
                            ...
                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="text" id="AR" class="form-control"
                                                            ...
                                                            data-validation-required-message="هذا الحقل مطلوب" value="{{$video->name_ar}}" >
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="" id="AR" class="form-control"
                                                            placeholder="اسم القسم" name="name_en" value="{{$video->name_en}}" >
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1" @if($video->status==1)selected @endif  >تفعيل</option>
                                        <option value="0" @if($video->status==0)selected @endif  >ايقاف</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="home3" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="subcategory" id="subcategory"
                                        ...
                                        <option value="{{$video->subcategory_id}}" selected > {{$video->subcategory->name_ar}}  
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="subsubcategory" id="filter"
                                        class="form-control m-b-10 select2-multiplel" 
                                        data-validation-required-message="هذا الحقل مطلوب" selected > 
                                        <option value="{{$video->subtwocategory_id}}" selected > {{$video->subtwocategory->name_ar}} </option> 
                                    </select>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" data-role="tagsinput" name="tag_ar"
                                                      value="{{$video->tag_ar}}"   class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" name="tag_en"
                                                        data-role="tagsinput" value="{{$video->tag_en}}" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12 form-group">
                            <div class="text-left">
                                ...
                                <div class="pull-right">
                                    <a href="{{route('Video.index')}}" class="btn btn-rounded btn-danger"> <span
