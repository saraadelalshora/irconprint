...
@section('content')
            ...
            <!-- ============================================================== -->
                ...
                <div class="row page-titles">
                    ...
                    <h4 class="text-themecolor"><a href="{{url('admin/video/Category')}}"> الأقسام الرئيسية</a></h4>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <form class=" p-t-20" method="POST" method="POST" action="{{url('admin/video/Category/'.$category->id)}}"  method="post"  enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                {{ method_field('PATCH') }}
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="text-left">
                                                    ...
                                                    <div class="pull-right">
                                                        <a href="{{url('admin/video/Category')}}" class="btn btn-rounded btn-danger"> <span class="fa fa-sign-out"> </span> &nbsp&nbspالعوده </a>
                                                    </div>                                     
                                                </div>
                                            </div>
                                    </form>
