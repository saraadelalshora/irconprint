                    ...
                    <div class="col-lg-12">
                        <div class="card">
                                <div class="card-header">
                                        <h4 class="card-white m-b-0">تعديل الادمن</h4>
                                </div>
                            <div class="card-body">

                                <div class="form-group">
                                <form class="p-t-20" method="POST" action="{{route('User.update',$customer->id)}}">
                                {{csrf_field()}}
                                {{ method_field('PATCH') }}
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" id="ُEmail" class="form-control" name="email" required value="{{$customer->email}}" placeholder="البريد الالكتروني">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                            <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="password" id="password-confirm"  name="password_confirmation"  class="form-control"  placeholder="تاكيد كلمة السر">
                                                                                                </div>
                                                                                    </div>
                                                                                    <!--/span-->
                                                                                </div>
