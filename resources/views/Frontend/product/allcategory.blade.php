...
<title>@lang('massege.All Product Categories')</title>
            ...
            <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
                <div class="title title-6 text-center">
                    <div class="title--heading">
                        <h1>@lang('massege.All Product Categories')</h1>
                    </div>
                    <div class="clearfix"></div>
                    <ol class="breadcrumb d-flex justify-content-center">
                        <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('massege.All Product Categories')</li>
                    </ol>
                </div><!-- .title end -->
            </div><!-- .col-md-12 end -->
        </div><!-- .row end -->
...
<section id="case" class="case case-standard case-3col pt-110 bg-gray">
    <div class="container">
        ...
        <div class="row">
            ...
            @foreach($all_product as $category)
                    ...
                    <div class="case--img">
                        ...
                        <div class="case--hover">
                            <div class="case--action">
                                @if(app()->getLocale() == 'ar')
                                <a href="{{route('category.products',$category->slogen_ar)}}"
                                    alt="{{$category->name_ar}}"> </a>
                                @else
                                <a href="{{route('category.products',$category->slogen_en)}}"
