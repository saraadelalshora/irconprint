                ...
                <div class="case-item-container">
                    <div class="case--img">
                        ...
                        <div class="case--hover">
                            ...
                            @if(app()->getLocale() == 'ar')
                               <a href="{{route('Subcategorytwo.products',$subcategory->slogen_ar)}}" alt="{{$subcategory->name_ar}}">  </a>
                            @else
                               <a href="{{route('Subcategorytwo.products',$subcategory->slogen_en)}}" alt="{{$subcategory->name_en}}">  </a>
                            @endif
                            </div>
                            <!-- .case-action end -->
                        </div>
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4>
                            @if(app()->getLocale() == 'ar')
                               <a href="{{route('Subcategorytwo.products',$subcategory->slogen_ar)}}"> {{$subcategory->name_ar}} </a>
                            @else
                               <a href="{{route('Subcategorytwo.products',$subcategory->slogen_en)}}"> {{$subcategory->name_en}} </a>
                            @endif
