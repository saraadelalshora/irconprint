...
@if($category->subtwocategories->isEmpty() != true)
<!-- Case carousel
============================================= -->
<section id="case" class="case case-standard case-3col pt-110 bg-gray">
    <div class="container">
            ...
            <!-- Case #1 -->
            @if($category->subtwocategories->isEmpty() != true)
            @foreach($category->subtwocategories()->paginate(15) as $subcategory)
                ...
                <div class="case-item-container">
                    <div class="case--img">
                        ...
                        <div class="case--hover">
                            ...
                            @if(app()->getLocale() == 'ar')
                               <a href="{{route('Subcategorytwo.trainings',$subcategory->slogen_ar)}}" alt="{{$subcategory->name_ar}}">  </a>
                            @else
                               <a href="{{route('Subcategorytwo.trainings',$subcategory->slogen_en)}}" alt="{{$subcategory->name_en}}">  </a>
                            @endif
                            </div>
                            <!-- .case-action end -->
                        </div>
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4>
                            @if(app()->getLocale() == 'ar')
                               <a href="{{route('Subcategorytwo.trainings',$subcategory->slogen_ar)}}"> {{$subcategory->name_ar}} </a>
                            @else
                               <a href="{{route('Subcategorytwo.trainings',$subcategory->slogen_en)}}"> {{$subcategory->name_en}} </a>
                            @endif
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-md-12 clearfix text--center">
                ...
                {!! $category->subtwocategories()->paginate(15)->appends(request()->except('page'))->links() !!} 
                </ul>
            </div>
            <!-- .col-md-12 end -->
          @else
