...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><a href="<?php echo e(route('eshop.index')); ?>"> المنتجات </a> </h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <a href="<?php echo e(route('eshop.create')); ?>"><button type="button"
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <form class=" p-t-20" method="POST" action="<?php echo e(route('eshop.store')); ?>"
                        ...
                        <div class="col-md-12 form-group">
                            <div class="text-left">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo e(route('eshop.index')); ?>" class="btn btn-rounded btn-danger"> <span
...
<script type="text/javascript">
    $('#Category').change(function () {
        ...
        if (countryID) {
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('admin/subcategory-list-shop')); ?>?category_id=" + countryID,
    ...
    $('#subcategory').on('change', function () {
        ...
        if (stateID) {
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('admin/filter-list-shop')); ?>?subcategory_id=" + stateID,
                success: function (res) {
                    if (res) {
                        $("#filter").empty();
