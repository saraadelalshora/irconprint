                                    ...
                                    <div class="module-container">
                                        <div class="contact-box pull-left">
                                            ...
                                            <div class="contact-box-info">
                                                ...
                                                <?php if(isset($setting->address)): ?> <p class="font-heading"> <?php echo e(ucwords($setting->address)); ?> </p> <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="contact-box pull-left">
                                            ...
                                            <div class="contact-box-info">
                                                ...
                                                <?php if(isset($setting->email)): ?> <p class="font-heading"><?php echo e($setting->email); ?></p> <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="contact-box pull-left">
                                            ...
                                            <div class="contact-box-info">
                                              ...
                                              <?php if(isset($setting->phone)): ?>  <p class="text-capitalize font-heading"><?php echo e($setting->phone); ?></p> <?php endif; ?>
                                            </div>
                                        </div>

                                        <!-- Module Social -->
                                        <div class="module module-social pull-left">
                                            <?php if(isset($social->fb)): ?> <a href="<?php echo e('https://'.$social->fb); ?>"><i
                                                    class="fab fa-facebook-f"></i></a> <?php endif; ?>
                                            <?php if(isset($social->tw)): ?><a href="<?php echo e('https://'.$social->tw); ?>"><i
                                                    class="fab fa-twitter"></i></a><?php endif; ?>
                                            <?php if(isset($social->linkedin)): ?><a href="<?php echo e('https://'.$social->linkedin); ?>"><i
                    ...
                    <div class="col-12 col-md-6 col-lg-3 footer--widget widget-about">
                        <div class="widget-content">
                            ...
                            <div class="social-icons">
                                <?php if(isset($social->fb)): ?> <a href="<?php echo e('https://'.$social->fb); ?>" class="facebook"> <i
                                        class="fab fa-facebook-f"></i></a> <?php endif; ?>
                                <?php if(isset($social->tw)): ?><a href="<?php echo e('https://'.$social->tw); ?>" class="twitter"><i
                                        class="fab fa-twitter"></i></a><?php endif; ?>
                                <?php if(isset($social->linkedin)): ?><a href="<?php echo e('https://'.$social->linkedin); ?>" class="linkedin"><i
                                        class="fab fa-linkedin-in"></i></a><?php endif; ?>
                                <?php if(isset($social->instegram)): ?><a href="<?php echo e('https://'.$social->instegram); ?>" class="linkedin"><i
                                        class="fab fa-linkedin-in"></i></a><?php endif; ?>
                                <?php if(isset($social->youtube)): ?><a href="<?php echo e('https://'.$social->youtube); ?>" class="linkedin"><i
                                        class="fab fa-linkedin-in"></i></a><?php endif; ?>
                                <?php if(isset($social->pinterest)): ?><a href="<?php echo e('https://'.$social->pinterest); ?>" class="linkedin"><i
                                        class="fab fa-linkedin-in"></i></a><?php endif; ?>
