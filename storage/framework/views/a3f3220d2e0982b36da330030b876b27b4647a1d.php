...
<title><?php echo app('translator')->getFromJson('massege.All Training Categories'); ?></title>
            ...
            <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
                <div class="title title-6 text-center">
                    <div class="title--heading">
                        <h1><?php echo app('translator')->getFromJson('massege.All Training Categories'); ?></h1>
                    </div>
                    <div class="clearfix"></div>
                    <ol class="breadcrumb d-flex justify-content-center">
                        <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->getFromJson('massege.All Training Categories'); ?></li>
                    </ol>
                </div><!-- .title end -->
            </div><!-- .col-md-12 end -->
        </div><!-- .row end -->
...
<section id="case" class="case case-standard case-3col pt-110 bg-gray">
    <div class="container">
        ...
        <div class="row">
            ...
            <?php $__currentLoopData = $all_training; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="case--img">
                        ...
                        <div class="case--hover">
                            <div class="case--action">
                                ...
                                <a href="<?php echo e(route('category.trainings',$category->slogen_ar)); ?>"
                                    alt="<?php echo e($category->name_ar); ?>"> </a>
                                <?php else: ?>
                                <a href="<?php echo e(route('category.trainings',$category->slogen_en)); ?>"
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-md-12 clearfix text--center">
                <ul class="pagination mt-20">
                    <?php echo $all_training->appends(request()->except('page'))->links(); ?>
