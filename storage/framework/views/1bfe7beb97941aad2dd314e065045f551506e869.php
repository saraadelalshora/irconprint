            ...
            <!-- ============================================================== -->
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor"><a href="<?php echo e(url('admin/product/Category')); ?>"> الأقسام الرئيسية</a></h4>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <form class=" p-t-20"   action="<?php echo e(url('admin/product/Category')); ?>"  method="post"  enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="text-left">
                                                    ...
                                                    <div class="pull-right">
                                                        <a href="<?php echo e(url('admin/product/Category')); ?>" class="btn btn-rounded btn-danger"> <span class="fa fa-sign-out"> </span> &nbsp&nbspالعوده </a>
                                                    </div>                                     
                                                </div>
                                            </div>
                                    </form>
