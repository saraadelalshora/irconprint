                    ...
                    <div class="col-lg-12">
                        <div class="card">
                                <div class="card-header">
                                        <h4 class="card-white m-b-0">اضافة مشروع </h4> 
                                </div>
                            <div class="card-body">
                                <div class="col-md-12 form-group">
                                    <ul class="nav nav-tabs tabcontent-border" role="tablist">
                                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home1" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">المشروع</span></a> </li>
                                ...
                                <div class="form-group">
                                    <form class=" p-t-20"   action="<?php echo e(route('Project.store')); ?>"  method="post"  enctype="multipart/form-data">
                                        ...
                                        <div class="tab-content">        
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                ...
                                                <div class="tab-content">        
                                                    <div class="tab-pane active" id="lang_ar" role="tabpanel">
                                                        <div class="form-group">
                                                            <div>
                                                                <label for="AR" class="control-label">اسم المشروع <span class="text-danger">*</span> </label>
                                                                    <div class="input-group-prepend controls">
                                                                        <input type="text" id="AR" class="form-control" placeholder="اسم المشروع" name="ar_name"  required data-validation-required-message="اسم المشروع  مطلوب">
                                                                    </div>
                                                            </div>
                                                            <hr>
                                                            <div>
                                                                <label for="textarea_ar" class="control-label"> وصف المشروع <span class="text-danger">*</span></label>
                                                                 <div class="controls">
                                                                    <textarea rows="5" id="textarea_ar" class="form-control" id="exampleTextarea" name="ar_description"  required placeholder="وصف المشروع"></textarea>
                                                                 </div>
                                                                </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane "  id="lang_en" role="tabpanel">
                                                        <div class="form-group">
                                                            <div>
                                                                <label for="en" class="control-label"> اسم المشروع </label>
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend">
                                                                        <input type="text" id="en" class="form-control" placeholder="اسم المشروع" name="en_name">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <hr>
                                                            <div>
                                                                <label for="textarea_en">وصف المشروع</label>
                                                                <div class="form-group">
                                                                    <textarea rows="5" id="textarea_en" class="form-control" placeholder="وصف المشروع" name="en_description"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane" id="home2" role="tabpanel">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">صورة ال مشروع</label>
                                                        <div class="card">
                                                            <div class="card-body">
