                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="<?php echo e(url('admin/training/SubtwoCategory/create')); ?>"><button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> إضافة جديد</button></a>
                ...
                <div class="row">
                    ...
                    <div class="card">
                                <div class="card-header">
                                        <h4 class="card-title m-b-0">قائمة بالأقسام الفرعية</h4>
                                </div>
                            <div class="card-body">
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        ...
                                        <th data-field="name">أسم القسم الفرعي عربي</th>
                                            <th data-field="name">أسم القسم الفرعي انجليزي</th>
                                    ...
                                    <tbody >
                                        ...
                                        <tr>
                                            ...
                                            <td data-field="edit"><button type="button" class="btn btn-sm btn-success btn-rounded m-l-15" ><i class="fa fa-check"></i><a href="<?php echo e(url('admin/training/SubtwoCategory/'.$value->id.'/edit')); ?>" style="color: #ffffff;"> تعديل</a></button>
                                            <form  action="<?php echo e(url('admin/training/SubtwoCategory/'.$value->id)); ?>"  style="display: inline;"  method="POST" accept-charset="utf-8">
