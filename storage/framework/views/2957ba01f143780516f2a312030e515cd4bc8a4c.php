...
<head>
   ...
   <link rel="stylesheet" href="<?php echo e(asset('/')); ?>/assets/node_modules/dropify/dist/css/dropify.min.css">
    ...
    <link href="<?php echo e(asset('/')); ?>/assets/dist/css/fontawesome-iconpicker.min.css" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/')); ?>/assets/dist/css/jquery.fonticonpicker.min.css" />
    <!-- Font -->
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/')); ?>/assets/dist/css/fontello-7275ca86/css/fontello.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/')); ?>/assets/dist/css/icomoon/style.css" /> -->
...
<body class="skin-blue fixed-layout">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('admin/eshop/Category')); ?>">الأقسام الرئيسية</a></li>
                                <li><a href="<?php echo e(route('eshop.index')); ?>">المنتجات</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
  ...
  <!--Wave Effects -->
    ...
    <script src="<?php echo e(asset('/')); ?>/assets/dist/js/fontawesome-iconpicker.js"></script>
    <script type="text/javascript" src="<?php echo e(asset('/')); ?>/assets/dist/js/jquery.fonticonpicker.min.js"></script>
