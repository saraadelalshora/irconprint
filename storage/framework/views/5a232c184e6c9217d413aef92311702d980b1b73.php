...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><a href="<?php echo e(route('shop.index')); ?>"> المنتجات </a> </h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <a href="<?php echo e(route('shop.create')); ?>"><button type="button"
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <form class=" p-t-20" method="POST" action="<?php echo e(route('shop.update',$product->id)); ?>"
                            ...
                            <div class="tab-pane" id="home3" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control m-b-10 select2-multiple" name="category_id"
                                        ...
                                        <option value="<?php echo e($category->id); ?>" <?php if($product->category->id ==
                        ...
                        <div class="col-md-12 form-group">
                            <div class="text-left">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo e(route('shop.index')); ?>" class="btn btn-rounded btn-danger"> <span
