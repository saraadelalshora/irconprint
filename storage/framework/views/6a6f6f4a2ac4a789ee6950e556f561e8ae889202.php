<?php $__env->startSection('content'); ?>
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">المشاريع </h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            
                            <a href="<?php echo e(route('Project.create')); ?>"><button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> إضافة جديد</button></a>
                ...
                <div class="row">
                    ...
                    <div class="card">
                                <div class="card-header">
                                        <h4 class="card-title m-b-0">قائمة  بالمشاريع</h4>
                                </div>
                            <div class="card-body">
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        ...
                                        <th data-field="name">أسم المشروع عربي</th>
                                            <th data-field="name">أسم المشروع انجليزي</th>
                                    ...
                                    <tbody >
                                        ...
                                        <tr>
                                            ...
                                            <td data-field="edit"><button type="button" class="btn btn-sm btn-success btn-rounded m-l-15" ><i class="fa fa-check"></i><a href="<?php echo e(route('Project.edit',$value->id)); ?>" style="color: #ffffff;"> تعديل</a></button>
                                            <form  action="<?php echo e(route('Project.destroy',$value->id)); ?>"  style="display: inline;"  method="POST" accept-charset="utf-8">
