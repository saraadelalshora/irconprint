        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <form class=" p-t-20" method="POST" action="<?php echo e(route('Product.update',$product->id)); ?>"
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="text" id="AR" class="form-control"
                                                            ...
                                                            data-validation-required-message="هذا الحقل مطلوب" value="<?php echo e($product->name_ar); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div>
                                                <label for="textarea_ar">وصف المنتج <span
                                                        class="text-danger">*</span></label>
                                                <div class="form-group">
                                                    <textarea class="summernote" name="description_ar"> <?php echo $product->description_ar; ?>
                                    ...
                                    <div class="tab-pane" id="lang_en" role="tabpanel">
                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="" id="AR" class="form-control"
                                                            placeholder="اسم القسم" name="name_en" value="<?php echo e($product->name_en); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <textarea class="summernote" name="description_en"><?php echo $product->description_en; ?>
                            ...
                            <div class="tab-pane" id="home3" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control m-b-10 select2-multiple" name="category_id"
                                        ...
                                        <option value="<?php echo e($category->id); ?>" <?php if($product->subcategory->category_id ==
                                            $category->id): ?> selected <?php endif; ?> ><?php echo e($category->name_ar); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="subcategory" id="subcategory"
                                        ...
                                        <option value="<?php echo e($product->subcategory_id); ?>" selected>
                                            <?php echo e($product->subcategory ->name_ar); ?></option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="subsubcategory" id="filter"
                                        ...
                                        <option value="<?php echo e($product->subtwocategory_id); ?>" selected>
                                            <?php echo e($product->subtwocategory ->name_ar); ?></option>
                            ...
                            <div class="tab-pane" id="home2" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="code" 
                                        data-validation-required-message="هذا الحقل مطلوب" value="<?php echo e($product->code); ?>">
                                </div>

                                <div class="form-group">
                                    <label class="control-label">الحالة </label>
                                    <select name="status" class="form-control">
                                        <option value="1" <?php if($product->status==1): ?>selected <?php endif; ?> >تفعيل</option>
                                        <option value="0" <?php if($product->status==0): ?>selected <?php endif; ?> >ايقاف</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">متاح </label>
                                    <select name="special" class="form-control">
                                        <option value="1" <?php if($product->availbale == 1): ?>selected <?php endif; ?> >نعم</option>
                                        <option value="0" <?php if($product->availbale == 0): ?>selected <?php endif; ?> >لا</option>
                                    </select>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                 ...
                                                 <div class="preview-images-zone">
                                                    ...
                                                    <div class="preview-image preview-show-<?php echo e($image->id); ?>">

                                                        <div class="image-cancel" data-no="<?php echo e($image->id); ?>">
                                                        ...
                                                        <div class="image-zone">
                                                            ...
                                                            <img id="pro-img-<?php echo e($image->id); ?>"
                                                                src="<?php echo e(asset($image->img)); ?>" class="img-fluid">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" data-role="tagsinput" name="tag_ar"
                                                      value="<?php echo e($product->tag_ar); ?>"    class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" name="tag_en"
                                                        data-role="tagsinput"  value="<?php echo e($product->tag_en); ?>" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    $(".deleteRecord").click(function () {
        ...
        //            data: {id:pointid,"_token": "<?php echo e(csrf_token()); ?>"},
