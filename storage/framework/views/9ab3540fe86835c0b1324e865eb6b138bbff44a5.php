...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><a href="<?php echo e(route('training.index')); ?>"> التدريبات </a> </h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <a href="<?php echo e(route('training.create')); ?>"><button type="button"
                    class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> تعديل
        التدريب</button></a>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-white m-b-0">التدريبات</h4>
            </div>
            <div class="card-body">
                    ...
                    <ul class="nav nav-tabs tabcontent-border" role="tablist">
                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home1"
                                role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span
                                    class="hidden-xs-down"> التدريب </span></a> </li>
                ...
                <form class=" p-t-20" method="POST" action="<?php echo e(route('training.update',$training->id)); ?>"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home1" role="tabpanel">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="lang_ar" role="tabpanel">
                                        <div class="form-group">
                                            <div>
                                                <label for="AR" class="control-label"> اسم التدريب<span
                                                        class="text-danger">*</span> </label>
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="text" id="AR" class="form-control"
                                                            placeholder=" اسم التدريب" name="name_ar" required
                                                            data-validation-required-message="هذا الحقل مطلوب" value="<?php echo e($training->name_ar); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div>
                                                <label for="textarea_ar">وصف التدريب <span
                                                        class="text-danger">*</span></label>
                                                <div class="form-group">
                                                    <textarea class="summernote" name="description_ar">

                                                              <?php echo $training->description_ar; ?>      </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="lang_en" role="tabpanel">
                                        <div class="form-group">
                                            <div>
                                                <label for="AR" class="control-label"> اسم التدريب </label>
                                                <div class="form-group">
                                                    <div class="input-group-prepend">
                                                        <input type="" id="AR" class="form-control"
                                                            placeholder="اسم القسم" name="name_en"value="<?php echo e($training->name_en); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div>
                                                <label for="textarea_ar"> وصف التدريب </label>
                                                <div class="form-group">
                                                    <textarea class="summernote" name="description_en">
                                                                 <?php echo $training->description_en; ?>   </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="home3" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control m-b-10 select2-multiple" name="category_id"
                                        ...
                                        <option value="<?php echo e($category->id); ?>"
                                         <?php if($training->subcategory->category_id == $category->id): ?> selected <?php endif; ?>><?php echo e($category->name_ar); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="subcategory" id="subcategory"
                                        ...
                                        <option value="<?php echo e($training->subcategory_id); ?>" selected>
                                            <?php echo e($training->subcategory ->name_ar); ?></option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="subsubcategory" id="filter"
                                        class="form-control m-b-10 select2-multiplel" 
                                        data-validation-required-message="هذا الحقل مطلوب"> 
                                       <?php if(!empty($training->subtwocategory)): ?> <option value="<?php echo e($training->subtwocategory_id); ?>" selected>
                                            <?php echo e($training->subtwocategory->name_ar); ?></option> <?php endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" id="AR" class="form-control"  placeholder="عدد ساعات التدريب " name="course_hour" 
                                                            data-validation-required-message="هذا الحقل مطلوب" value="<?php echo e($training->course_hour); ?>">
                                </div>
                                <div class="form-group">
                                  ...
                                  <input type="date" id="AR" class="form-control"
                                                            ...
                                                            data-validation-required-message="هذا الحقل مطلوب" value="<?php echo e($training->course_date); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1"  <?php if($training->status == 1): ?>selected <?php endif; ?>  >تفعيل</option>
                                        <option value="0"  <?php if($training->status == 0): ?>selected <?php endif; ?> >ايقاف</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="card">
                                                            <div class="card-body">
                                                                <label>Upload Image</label>
                                                                    <input type="file" name="pro_image" id="input-file-now" class="dropify" <?php if(!empty($training->image)): ?> data-default-file="<?php echo e(asset($training->image)); ?>" <?php endif; ?>/>
                                                                </div>
                                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" data-role="tagsinput" name="tag_ar"
                                                        value="<?php echo e($training->tag_ar); ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" name="tag_en"
                                                      value="<?php echo e($training->tag_en); ?>"  data-role="tagsinput">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12 form-group">
                            <div class="text-left">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo e(route('training.index')); ?>" class="btn btn-rounded btn-danger"> <span
...
<script type="text/javascript">
    $('#Category').change(function () {
        ...
        if (countryID) {
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('admin/subcategory-list-training')); ?>?category_id=" + countryID,
    ...
    $('#subcategory').on('change', function () {
        ...
        if (stateID) {
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('admin/filter-list-training')); ?>?subcategory_id=" + stateID,
                success: function (res) {
                    if (res) {
                        // $("#filter").empty();
