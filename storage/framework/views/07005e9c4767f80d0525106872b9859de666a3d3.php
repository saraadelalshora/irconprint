                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <form class=" p-t-20" action="<?php echo e(url('admin/product/SubCategory/'.$subcategory->id)); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="tab-content">        
                                                        ...
                                                        <div class="form-group">
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend">
                                                                        <input type="text" id="AR" class="form-control" placeholder="اسم القسم" required value="<?php echo e($subcategory->name_ar); ?>" name="name_ar">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <hr>
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo $subcategory->description_ar; ?>
                                                    ...
                                                    <div class="tab-pane" id="lang_en" role="tabpanel">
                                                        <div class="form-group">
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend">
                                                                        <input type="text" id="AR" class="form-control" placeholder="اسم القسم" name="name_en" value="<?php echo e($subcategory->name_en); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <hr>
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo $subcategory->description_en; ?>
                                            ...
                                            <div class="tab-pane" id="home2" role="tabpanel">
                                                <div class="form-group">
                                                    ...
                                                    <?php if(!empty($categories)): ?> <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($subcategory->category_id); ?>" selected><?php echo e($category->name_ar); ?></option>       
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">صورة ال قسم</label>
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <input type="file" name="image" id="input-file-now" <?php if(!empty($subcategory->image)): ?> data-default-file="<?php echo e(asset($subcategory->image)); ?>" <?php endif; ?> class="dropify" />
                                                            </div>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label"> الحاله </label>
                                                        <select name="status" class="form-control">
                                                            <option value="1" <?php if($subcategory->status == 1): ?>selected <?php endif; ?>>تفعيل</option>
                                                            <option value="0" <?php if($subcategory->status == 0): ?>selected <?php endif; ?>>ايقاف</option>
                                                        </select>
                                            </div>
                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <br>
                                                                    <div class="input-group-prepend">
                                                                        ...
                                                                        <input type="text" data-role="tagsinput" name="tag_ar" value="<?php echo e($subcategory->tag_ar); ?>" class="form-control" >
                                                                    </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <br>
                                                                    <div class="input-group-prepend">
                                                                        ...
                                                                        <input type="text" class="form-control" name="tag_en" value="<?php echo e($subcategory->tag_en); ?>"data-role="tagsinput">
                                                                    </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="text-left">
                                                    ...
                                                    <div class="pull-right">
                                                        <a href="<?php echo e(url('admin/product/SubCategory/')); ?>" class="btn btn-rounded btn-danger"> <span class="fa fa-sign-out"> </span> &nbsp&nbspالعوده </a>
                                                    </div>                                     
                                                </div>
                                            </div>
                                    </form>
