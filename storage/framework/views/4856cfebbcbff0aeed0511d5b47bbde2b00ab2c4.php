<?php $__env->startSection('content'); ?>
            ...
            <!-- ============================================================== -->
                ...
                <div class="row page-titles">
                    ...
                    <h4 class="text-themecolor"><a href="<?php echo e(route('Project.index')); ?>"> المشاريع</a></h4>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <form class=" p-t-20" method="POST" method="POST" action="<?php echo e(route('Project.update',$project->id)); ?>"  method="post"  enctype="multipart/form-data">
                                                            ...
                                                            <div>
                                                                <label for="AR" class="control-label">اسم القسم <span class="text-danger">*</span></label>
                                                                    <div class="input-group-prepend controls">
                                                                        <input type="text" id="AR" class="form-control" placeholder="اسم القسم" value="<?php echo e($project->name_ar); ?>" name="ar_name" required data-validation-required-message="اسم القسم  مطلوب">
                                                                    </div>
                                                            </div>
                                                            <hr>
                                                            <div>
                                                                ...
                                                                <div class="controls">
                                                                    <textarea class="summernote" id="textarea_ar" class="form-control" name="ar_description" placeholder="وصف القسم" required ><?php echo e($project->description_ar); ?></textarea>
                                                            </div>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane"  id="lang_en" role="tabpanel">
                                                        <div class="form-group">
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend">
                                                                        <input type="text" id="AR" class="form-control" placeholder="اسم القسم" name="en_name" value="<?php echo e($project->name_en); ?>" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <hr>
                                                            <div>
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea class="summernote" id="textarea_ar" class="form-control" placeholder="وصف القسم" name="en_description"><?php echo e($project->description_en); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane" id="home2" role="tabpanel">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">صورة ال قسم</label>
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <input type="file" name="img" id="input-file-now" class="dropify" <?php if(!empty($project->image)): ?> data-default-file="<?php echo e(asset($project->image)); ?>" <?php endif; ?>/>
                                                            </div>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label"> الحاله </label>
                                                        ...
                                                        <option value="1"<?php echo e($project->status == 1 ? 'selected="selected"' : ''); ?> >تفعيل</option>
                                <option value="0" <?php echo e($project->status == 0 ? 'selected="selected"' : ''); ?>>ايقاف</option>
                                                        </select>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <br>
                                                                    <div class="input-group-prepend">
                                                                        ...
                                                                        <input type="text" name="ar_tag" value="<?php echo e($project->tag_ar); ?>" data-role="tagsinput" class="form-control" >
                                                                    </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <br>
                                                                    <div class="input-group-prepend">
                                                                        ...
                                                                        <input type="text" name="en_tag" value="<?php echo e($project->tag_en); ?>" class="form-control" data-role="tagsinput">
                                                                    </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="text-left">
                                                    ...
                                                    <div class="pull-right">
                                                        <a href="<?php echo e(route('Project.index')); ?>" class="btn btn-rounded btn-danger"> <span class="fa fa-sign-out"> </span> &nbsp&nbspالعوده </a>
                                                    </div>                                     
                                                </div>
                                            </div>
                                    </form>
