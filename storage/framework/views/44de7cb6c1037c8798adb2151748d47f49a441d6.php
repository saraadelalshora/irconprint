                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                 <?php if($social != null): ?>
                                    <form class=" p-t-20" method="POST" action="<?php echo e(route('updatesocial',$social->id)); ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                              <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Facebook" name="fb" value="<?php echo e($social->fb); ?>">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label class="control-label">Twitter</label>
                                                    <input type="text" class="form-control" placeholder="Twitter" name="tw" value="<?php echo e($social->tw); ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">Instegram</label>
                                                    <input type="text" class="form-control" placeholder="Instegram" name="instegram" value="<?php echo e($social->instegram); ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">Linked in</label>
                                                    <input type="text" class="form-control" placeholder="Linked in" name="linkedin" value="<?php echo e($social->linkedin); ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">Youtube</label>
                                                    <input type="text" class="form-control" placeholder="Youtube" name="youtube" value="<?php echo e($social->youtube); ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">Pinterest</label>
                                                    <input type="text" class="form-control" placeholder="Pinterest" name="pinterest" value="<?php echo e($social->pinterest); ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label">Android app link</label>
                                                    <input type="text" class="form-control" placeholder="RSS" name="rss" value="<?php echo e($social->rss); ?>">
                                                </div>
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="text-left">
                                                    ...
                                                    <div class="pull-right">
                                                        <a href="<?php echo e(url('admin')); ?>" class="btn btn-rounded btn-danger"> <span class="fa fa-sign-out"> </span> &nbsp&nbspتعديل </a>
                                                    </div>
                                                </div>
                                            </div>
                                    </form>
                                    <?php else: ?>
                                    <form class=" p-t-20" method="POST" action="<?php echo e(route('savesocial')); ?>" enctype="multipart/form-data">
                                    <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="text-left">
                                                    ...
                                                    <div class="pull-left">
                                                        <a href="<?php echo e(url('admin')); ?>" class="btn btn-rounded btn-danger"> <span class="fa fa-sign-out"> </span> &nbsp&nbspBack </a>
                                                    </div>
                                                </div>
                                            </div>
                                    </form>
