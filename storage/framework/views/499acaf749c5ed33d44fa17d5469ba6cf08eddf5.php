        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <form class="p-t-20" method="POST" action="<?php echo e(route('About.update',$page->id)); ?>" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 form-group">
                            <div class="text-left">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo e(route('About.index')); ?>" class="btn btn-rounded btn-danger">
