                ...
                <div class="case-item-container">
                    <div class="case--img">
                        ...
                        <div class="case--hover">
                            ...
                            <?php if(app()->getLocale() == 'ar'): ?>
                               <a href="<?php echo e(route('Subcategorytwo.products',$subcategory->slogen_ar)); ?>" alt="<?php echo e($subcategory->name_ar); ?>">  </a>
                            <?php else: ?>
                               <a href="<?php echo e(route('Subcategorytwo.products',$subcategory->slogen_en)); ?>" alt="<?php echo e($subcategory->name_en); ?>">  </a>
                            <?php endif; ?>
                            </div>
                            <!-- .case-action end -->
                        </div>
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4>
                            <?php if(app()->getLocale() == 'ar'): ?>
                               <a href="<?php echo e(route('Subcategorytwo.products',$subcategory->slogen_ar)); ?>"> <?php echo e($subcategory->name_ar); ?> </a>
                            <?php else: ?>
                               <a href="<?php echo e(route('Subcategorytwo.products',$subcategory->slogen_en)); ?>"> <?php echo e($subcategory->name_en); ?> </a>
                            <?php endif; ?>
                ...
                <div class="case-item-container">
                    <div class="case--img">
                        ...
                        <div class="case--hover">
                            <div class="case--action">
                            <?php if(app()->getLocale() == 'ar'): ?>
                               <a href="<?php echo e(route('product.name',$categoryproduct->slogen_en)); ?>" alt="<?php echo e($categoryproduct->name_ar); ?>">  </a>
                            <?php else: ?>
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4>
                            <?php if(app()->getLocale() == 'ar'): ?>
                               <a href="<?php echo e(route('product.name',$categoryproduct->slogen_en)); ?>"> <?php echo e($categoryproduct->name_ar); ?> </a>
                            <?php else: ?>
