<?php $__env->startSection('content'); ?>
  <!-- ============================================================== -->
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <form class="p-t-20" method="POST"action="<?php echo e(route('Slider.store')); ?>"  method="post"  enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <div class="text-left">
                                                ...
                                                <div class="pull-right">
                                                    <a href="<?php echo e(route('Slider.index')); ?>" class="btn btn-rounded btn-danger">
