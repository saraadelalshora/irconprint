                ...
                <div class="case-item-container">
                    <div class="case--img">
                        ...
                        <div class="case--hover">
                            ...
                            <?php if(app()->getLocale() == 'ar'): ?>
                               <a href="<?php echo e(route('Subcategory.trainings',$subcategory->slogen_ar)); ?>" alt="<?php echo e($subcategory->name_ar); ?>">  </a>
                            <?php else: ?>
                               <a href="<?php echo e(route('Subcategory.trainings',$subcategory->slogen_en)); ?>" alt="<?php echo e($subcategory->name_en); ?>">  </a>
                            <?php endif; ?>
                            </div>
                            <!-- .case-action end -->
                        </div>
                    ...
                    <div class="case--content">
                        ...
                        <div class="case--title">
                            <h4>
                            <?php if(app()->getLocale() == 'ar'): ?>
                               <a href="<?php echo e(route('Subcategory.trainings',$subcategory->slogen_ar)); ?>"> <?php echo e($subcategory->name_ar); ?> </a>
                            <?php else: ?>
                               <a href="<?php echo e(route('Subcategory.trainings',$subcategory->slogen_en)); ?>"> <?php echo e($subcategory->name_en); ?> </a>
                            <?php endif; ?>
