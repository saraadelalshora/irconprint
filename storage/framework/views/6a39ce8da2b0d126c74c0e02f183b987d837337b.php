                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php if($setting != null): ?>
                                    <form class=" p-t-20" method="POST" action="<?php echo e(route('setting.update',['Setting'=>$setting->id])); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="tab-content">        
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                <div class="form-group">
                                                    ...
                                                    <textarea  class="form-control" style="height:120px" placeholder="نبذه عن الموقع" name="description_ar"> <?php echo e($setting->description_ar); ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">نبذه عن الموقع انجليزي</label>
                                                    <textarea  class="form-control" style="height:120px" placeholder="نبذه عن الموقع" name="description_en"> <?php echo e($setting->description_en); ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">عنوان ال meta</label>
                                                    <input type="text" class="form-control" placeholder="عنوان ال meta" name="meta_title" value="<?php echo e($setting->meta_title); ?>">
                                                </div>

                                                <div class="form-group ">
                                                    <label class="control-label">وصف ال meta tag</label>
                                                        <div class="col-md-12">
                                                        <input  class="form-control"  placeholder="وصف ال meta tag" name="meta_tags"data-role="tagsinput" value="<?php echo e($setting->meta_tags); ?>">
                                                </div>
                                                   </div>
                                                <div class="form-group">
                                                    <label class="control-label">الكلمات الدلاليه لل meta tag</label>
                                                        <textarea  class="form-control" style="height:120px" placeholder="الكلمات الدلاليه لل meta tag" name="meta_description_ar"> <?php echo e($setting->meta_description_ar); ?></textarea>
                                                </div>
                                            ...
                                            <div class="tab-pane" id="home2" role="tabpanel">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="العنوان"  name="address" value="<?php echo e($setting->address); ?>">
                                                </div>
                                                
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">واتساب</label>
                                                        <input type="text" class="form-control" placeholder="واتساب"  name="whatsapp" value="<?php echo e($setting->whatsapp); ?>">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">البريد الالكترونى</label>
                                                        <input type="email" class="form-control" placeholder="البريد الالكترونى"  name="email" value="<?php echo e($setting->email); ?>">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">رقم الهاتف</label>
                                                        <input type="tel" class="form-control" placeholder="رقم الهاتف"  name="phone" value="<?php echo e($setting->phone); ?>">
                                                </div>
                                                
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">الكود قبل ال Head</label>
                                                        <textarea  class="form-control" style="height:120px" placeholder="الكود قبل ال Head" name="head_code"> <?php echo e($setting->head_code); ?></textarea>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">تعليق</label>
                                                        <textarea  class="form-control" style="height:120px" placeholder="تعليق" name="notes"> <?php echo e($setting->notes); ?></textarea>
                                                </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="file" id="input-file-now"  name="logo_img" class="dropify" <?php if(!empty($setting->logo_img)): ?> data-default-file="<?php echo e(asset($setting->logo_img)); ?>" <?php endif; ?> />
                                                                    </div>
                                                            </div>
                                                            <div class="form-group col-md-3">
                                                                <label class="control-label">صوره الموقع انجليزي</label>
                                                                <input type="file" id="input-file-now" class="dropify" name="log_img_en" <?php if(!empty($setting->log_img_en)): ?> data-default-file="<?php echo e(asset($setting->log_img_en)); ?>" <?php endif; ?> />
                                                            </div>
                                                            <div class="col-lg-3 col-md-3">
                                                                    <div class="form-group">
                                                                            <label class="control-label">ايقونه الموقع</label>
                                                                        <input type="file" id="input-file-now" name="icon_img" class="dropify" <?php if(!empty($setting->icon_img)): ?> data-default-file="<?php echo e(asset($setting->icon_img)); ?>" <?php endif; ?> />
                                                                    </div>
                                                                </div>    
                                                        </div>
                                            ...
                                            <div class="tab-pane" id="home4" role="tabpanel">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="customRadio1" placeholder="customRadio" class="custom-control-input" name="check" value="1" <?php echo e(($setting->maintans_status =="1")? "checked" : ""); ?> >
                                                            <label class="custom-control-label" for="customRadio1">نعم</label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="customRadio2" placeholder="customRadio" class="custom-control-input" name="check" value="0" <?php echo e(($setting->maintans_status =="0")? "checked" : ""); ?>>
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="text-left">
                                                    ...
                                                    <div class="pull-right">
                                                        <a href="<?php echo e(url('admin')); ?>" class="btn btn-rounded btn-danger"> <span class="fa fa-sign-out"> </span> &nbsp&nbspالعوده </a>
                                                    </div>                                     
                                                </div>
                                            </div>
                                    </form>
                                <?php else: ?>
                                <form class=" p-t-20" method="POST" action="<?php echo e(route('setting.store')); ?>" enctype="multipart/form-data">
                                    <?php echo e(csrf_field()); ?>                                  
                                        <div class="tab-content">        
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                <div class="form-group">
