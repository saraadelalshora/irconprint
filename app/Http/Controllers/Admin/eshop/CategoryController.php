...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $all=Category::where('type','eshop')->orderBy('id', 'desc')->get();
        // dd($all);
        return view('Admin.eshop.categories.index',compact('all'));
    }
    ...
    {
        //
        return view('Admin.eshop.categories.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $category->type='eshop';
        $category->save();
        return  redirect('admin/shop/Category')->with('success','تم اضافة القسم الرئيسي بنجاح');
    ...
    public function edit($id)
    {
        ...
        return view('Admin.eshop.categories.edit',compact('category'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $category->type='eshop';
        $category->save();
        return  redirect('admin/shop/Category')->with('success','تم تعديل القسم الرئيسي بنجاح');
    }
    ...
    public function destroy($id)
    {
        ...
        $category->delete();
        return  redirect('admin/shop/Category')->with('success','تم الحذف المصنع بنجاح');
