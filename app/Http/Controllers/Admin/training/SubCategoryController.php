...
class SubCategoryController extends Controller
{
    ...
    {
        //
        $all=Sub_Category::where('type','training')->orderBy('id', 'desc')->get();
        return view('Admin.training.subcategories.index',compact('all'));
    }
    ...
    public function create()
    {
        ...
        return view('Admin.training.subcategories.create',compact('categories'));
    ...
    public function store(Request $request)
    {
        ...
        // }
        return  redirect('admin/training/SubCategory')->with('success','تم اضافة القسم الفرعي بنجاح');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Admin.training.subcategories.edit',compact('subcategory','categories'));
    ...
    public function update(Request $request, $id)
    {
        ...
        //     $subcategory->filters()->sync($filter);
        // }
        return  redirect('admin/training/SubCategory')->with('success','تم تعديل القسم الفرعي بنجاح');
    }
    ...
    public function destroy($id)
    {
        ...
        return  redirect('admin/training/SubCategory')->with('success','تم حذف القسم الفرعي بنجاح');
    }
