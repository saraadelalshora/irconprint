...
class SubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Admin.subcategories.index',compact('all'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            if (!file_exists('public/subcategory/larg/')) {
                mkdir('public/subcategory/larg/', 0777, true);
            }
            if (!file_exists('public/subcategory/small/')) {
                mkdir('public/subcategory/small/', 0777, true);
            }
            $image_resize = Image::make($file->getRealPath());
            $image_resize->resize(500, 500);
            $image_resize->save(public_path('subcategory/larg/' .$imageName));
            $image_resize1 = Image::make($file->getRealPath());
            $image_resize1->resize(250, 250);
            $image_resize1->save(public_path('subcategory/small/' .$imageName));
            $subcategory->image='subcategory/larg/'.$imageName;
        ...
        // }
        return  redirect('admin/SubCategory')->with('success','تم اضافة القسم الفرعي بنجاح');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //     $subcategory->filters()->sync($filter);
        // }
        return  redirect('admin/SubCategory')->with('success','تم تعديل القسم الفرعي بنجاح');
    }
