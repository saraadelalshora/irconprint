...
class SubtwoCategoryController extends Controller
{
 /**
    ...
    {
        //
        $all=SubTwoCategory::where('type','video')->orderBy('id', 'desc')->get();
        return view('Admin.video.subtwocategories.index',compact('all'));
    }
    ...
    public function create()
    {
        ...
        $categories =Sub_Category::where([['status','1'],['type','video']])->get();
        return view('Admin.video.subtwocategories.create',compact('categories'));
    ...
    public function store(Request $request)
    {
        ...
        // }
        return  redirect('admin/video/SubtwoCategory')->with('success','تم اضافة القسم الفرعي بنجاح');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Admin.video.subtwocategories.edit',compact('subcategory','categories'));
    ...
    public function update(Request $request, $id)
    {
        ...
        //     $subcategory->filters()->sync($filter);
        // }
        return  redirect('admin/video/SubtwoCategory')->with('success','تم تعديل القسم الفرعي بنجاح');
    }
    ...
    public function destroy($id)
    {
        ...
        return  redirect('admin/video/SubtwoCategory')->with('success','تم حذف القسم الفرعي بنجاح');
    }
